...
>
> Те саме стосується push: єдиний дозволений push — `git push origin main` з
> checkout `main`. Ніколи не пушити `HEAD`, ніколи не пушити в інший remote
> ref, ніколи не залишати роботу на сторонній remote-гілці. Стороння
> remote-гілка має єдину дозволену операцію — видалення.
>
