...
APP_AUTHOR = "VOICE Studio Project"
...
def config_dir() -> Path:
    return _directory_override("VOICE_STUDIO_CONFIG_DIR") or Path(
        user_config_dir(APP_NAME, APP_AUTHOR)
    )


def data_dir() -> Path:
    return _directory_override("VOICE_STUDIO_DATA_DIR") or Path(
        user_data_dir(APP_NAME, APP_AUTHOR)
    )


def cache_dir() -> Path:
    return _directory_override("VOICE_STUDIO_CACHE_DIR") or Path(
