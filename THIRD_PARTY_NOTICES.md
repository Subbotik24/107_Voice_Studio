...
from source code. Their upstream provenance, revision, model card, license, file
inventory and SHA-256 must be included with the `models-v1` GitHub Release.

This document is a notice index, not legal advice. Release maintainers must
verify every packaged dependency and upstream model license at release time.
